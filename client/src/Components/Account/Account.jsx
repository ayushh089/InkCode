...
const Account = () => {
  ...
  return (
    <div className="p-4 bg-slate-800 rounded-md shadow-md max-w-md mx-auto h-full">
      <h2 className="text-white text-xl font-semibold mb-4">Hello, {username}</h2>
      ...
      {copySuccess && (
        <div className="text-green-500 text-sm mt-2">Code copied to clipboard!</div>
      )}
      <div>
       
        <button className=" bg-blue-500 text-white px-4 py-2 mb-5 p-3  rounded-md fixed bottom-0 ">
            Leave Room
        </button>
